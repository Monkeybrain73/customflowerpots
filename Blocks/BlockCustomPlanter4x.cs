...
{
    public class BlockPlantContainer4x : Block
    {
        ...
        {
            var be = world.BlockAccessor.GetBlockEntity(pos) as BlockEntityCustomPlantContainer4x;
        ...
        public override void OnDecalTesselation(IWorldAccessor world, MeshData decalMesh, BlockPos pos)
        {
            ...
            BlockEntityCustomPlantContainer4x bept = world.BlockAccessor.GetBlockEntity(pos) as BlockEntityCustomPlantContainer4x;
            if (bept != null)
            {
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack)
        {
            ...
            if (val)
            {
                BlockEntityCustomPlantContainer4x bect = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityCustomPlantContainer4x;
                if (bect != null)
                {
        ...
        {
            BlockEntityCustomPlantContainer4x be = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityCustomPlantContainer4x;
